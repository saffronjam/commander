...
export type SessionUpdatedSubscription = { sessionUpdated: { id: string, name: string, address: string, sessionName: string, isPaused: boolean, createdAt: string, isOnline: boolean, isDisconnected: boolean, stage: SessionStage } };
...
export type LoginMutation = { login: { success: boolean, usedDefaultPassword: boolean } };

export type AuthStatusQueryVariables = Exact<{ [key: string]: never; }>;


export type AuthStatusQuery = { authStatus: { authenticated: boolean, usedDefaultPassword: boolean } };
...
export type SessionsQuery = { sessions: Array<{ id: string, name: string, address: string, sessionName: string, isPaused: boolean, createdAt: string, isOnline: boolean, isDisconnected: boolean, stage: SessionStage }> };
...
export type SessionQuery = { session: { id: string, name: string, address: string, sessionName: string, isPaused: boolean, createdAt: string, isOnline: boolean, isDisconnected: boolean, stage: SessionStage } | null };
...
export type CreateSessionMutation = { createSession: { id: string, name: string, address: string, sessionName: string, isPaused: boolean, createdAt: string, isOnline: boolean, isDisconnected: boolean, stage: SessionStage } };
...
export type UpdateSessionMutation = { updateSession: { id: string, name: string, address: string, sessionName: string, isPaused: boolean, createdAt: string, isOnline: boolean, isDisconnected: boolean, stage: SessionStage } };
